...
if ("POST".equals(request.getMethod()))
{
	...
	*/
	...
	String _transParam1		= uploader.getParameter("transParam1");		// 사용자에게 입력받은 생년월일(birth) 값
	
	/*
		업로드 시 서버 저장경로 지정 
		uploader.setDirectory()
		- uploader.run() 이전에 선언하여 변경가능합니다.
	*/
	String subDir = _transParam1;
	uploader.setDirectory(directory + "/" + subDir); // 입력받은 값으로 폴더생성하려 서버의 저장 경로를 별도로 지정
